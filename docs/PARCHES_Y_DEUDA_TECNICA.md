...
| T-022a-pend | **Pendientes de T-022a:** (a) T-025 extracción de líneas Amazon; (b) T-026 auto-match cuotas financiadas; ~~(c) slice-1b map comercio→categoría IA~~ **RESUELTA T-023 (02-jun-2026)**; (d) PV-3 indicador compromisos en Control; (e) Splits multi-categoría por pedido. | Media |
